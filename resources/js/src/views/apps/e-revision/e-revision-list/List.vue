          ...
          <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
              ...
              <b-button variant="primary" @click="isAddNewUserSidebarActive = true">
                <span class="text-nowrap">Add eRevision</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchUsers" responsive :fields="tableColumns"
        ...
        <template #cell(actions)="data">
          <b-dropdown variant="link" no-caret :right="$store.state.appConfig.isRTL">
            ...
            <b-dropdown-item  @click="$router.push({ name: 'add-notes', params: { id: data.item.id, user: data.item.title } })">
              <feather-icon icon="FileIcon" />
              <span class="align-middle ml-50">Add Notes</span>
            </b-dropdown-item>
            <b-dropdown-item  @click="$router.push({ name: 'add-questionnaire', params: { id: data.item.id, user: data.item.title } })">
              <feather-icon icon="FileIcon" /> 
              <span class="align-middle ml-50">Add Questionnaire</span>
            </b-dropdown-item>
...
export default {
  ...
  setup() {
    ...
    const roleOptions = [
      { label: 'MCQ', value: 'mcq' },
      { label: 'Fill In Box', value: 'fill' },
      { label: 'Printable Worksheet', value: 'worksheet' },
    ]
