  ...
  <b-sidebar id="add-new-user-sidebar" :visible="isAddNewUserSidebarActive" bg-variant="white"
    ...
    <template #default="{ hide }">
      ...
      <div class="
          ...
          py-1
        ">
        <h5 class="mb-0"> {{ editData.id ? 'Update' : 'Add ' }} E Token
        </h5>
      ...
      <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
        ...
        <b-form class="p-2" @submit.prevent="handleSubmit(onSubmit)" @reset.prevent="resetForm"
          ...
          <!-- token_amount -->
          <validation-provider #default="validationContext" name="token_amount" rules="required">
            <b-form-group label="Token" label-for="token_amount">
              <b-form-input id="token_amount" v-model="editData.token_amount" autofocus :state="getValidationState(validationContext)"
                trim placeholder="" />
