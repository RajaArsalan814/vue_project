  ...
  <b-sidebar id="add-new-user-sidebar" :visible="isAddNewUserSidebarActive" bg-variant="white"
    ...
    <template #default="{ hide }">
      ...
      <div class="
          ...
          py-1
        ">
        <h5 class="mb-0"> {{ editData.id ? 'Update' : 'Add ' }} Gls</h5>
      ...
      <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
        ...
        <b-form class="p-2" @submit.prevent="handleSubmit(onSubmit)" @reset.prevent="resetForm">
          ...
          <validation-provider #default="validationContext" name="name" rules="required">
            <b-form-group label="Gls Name" label-for="name">
              <b-form-input id="name" v-model="editData.name" autofocus :state="getValidationState(validationContext)"
                trim placeholder="" />
