...
export default function useUsersList() {
  ...
  // Table Handlers
  const tableColumns = [
    { key: 'message', label: 'Logs', sortable: true },  
  ]
  ...
  const fetchUsersPayment = (ctx, callback) => {
    store
      .dispatch('app-user/fetchUsersPayment', {
        q: searchQuery.value,
        perPage: perPage.value,
        page: currentPage.value,
        sortBy: sortBy.value,
  ...
  const fetchUsersClass = (ctx, callback) => {
    store
      .dispatch('app-user/fetchUsersClass', {
        q: searchQuery.value,
        perPage: perPage.value,
        page: currentPage.value,
        sortBy: sortBy.value,
