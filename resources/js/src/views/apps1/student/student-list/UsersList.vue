      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchUsers" responsive :fields="tableColumns"
        ...
        <template #cell(user)="data">
          <b-media vertical-align="center">
            <template #aside>
              <b-avatar size="32" :src="data.item.first_name" :text="avatarText(data.item.first_name)"
        ...
        <template #cell(actions)="data">
          <div class="text-nowrap">
            <b-badge pill variant="primary" class="cursor-pointer" :id="`invoice-row-${data.item.id}-preview-icon`"
              @click="$router.push({ name: 'assign-module', params: { id: data.item.user_id, user: data.item.username } })">
              <feather-icon icon="PlusIcon" size="16" /> Assign Module
            </b-badge>
