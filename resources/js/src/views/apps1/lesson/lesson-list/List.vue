  ...
  <!--   <users-list-filters
    ...
    >
      ...
      <template #cell(component)="data">
          {{ data.item.component.toUpperCase() }}
        </template>
        ...
        <template #cell(status)="data">
          ...
          >
            {{ resolveUserStatusVariantData(data.item.status) }}
          </b-badge>
        </template>
...
/*   const delete_annannouncement = (id) => {
    ...
    const roleOptions = [
      ...
      { label: 'E-Reading Scholars', value: 'E-Reading Scholars' },
      { label: 'E-Creative Life Application', value: 'E-Creative Life Application' },  
      { label: 'Eloquent Speaker', value: 'Eloquent Speaker' },  
      { label: 'School of Grammar', value: 'School of Grammar' },  
      { label: 'Write Right Composer', value: 'Write Right Composer' },  
      { label: 'Intelligent Vocbulary Builder', value: 'Intelligent Vocbulary Builder' },  
      { label: 'Phonics Bridging', value: 'Phonics Bridging' },  
