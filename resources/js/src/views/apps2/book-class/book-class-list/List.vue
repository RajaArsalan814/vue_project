<template>
  ...
  <div>
    <h3 class="text-nowrap">List of Booked Class</h3>
   ...
   <!--        <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
              ...
              <b-button variant="primary" @click="isAddNewUserSidebarActive = true">
                <span class="text-nowrap">Add E Token to {{$route.params.user}}</span>
              </b-button>
            </div>
          </b-col> -->
        </b-row>
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchUsers" responsive :fields="tableColumns"
        ...
        <template #cell(time_slot)="data">
          <b-badge pill variant="light-primary" class="text-capitalize" v-for="item in JSON.parse(data.item.time_slot)"
